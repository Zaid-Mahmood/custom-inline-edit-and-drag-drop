        ...
        <div>
            <div className='bg-conic from-blue-600 to-sky-400 to-50% h-full'>
                ...
                <div className="mt-4 flex items-center justify-between mx-5">
                    <div className='p-4 border border-secondary rounded-xl w-[70%] h-full bg-no-repeat bg-center bg-cover my-12 text-center mx-auto' style={{ backgroundImage: `url(${loginImg})` }}>
                        <div className='flex flex-col justify-center space-y-12 h-full mx-auto w-1/2'>
                            <input className='border-b-2 border-gray-100 outline-0' placeholder='Name' type='text' />
                            ...
                            <div className='flex space-x-5'>
                                <p className='text-[#907974]'>Gender</p>
                                ...
                                <label className='text-[#907974]' for="male">Male</label>
                                ...
                                <label className='text-[#907974]' for="female">Female</label>
                            </div>
                            <div className='flex space-x-4'>
                                <label className="cursor-pointer font-normal text-[#907974] rounded-md p-4">
                                    Upload Image
                                </label>
                                <input
                                    ref={fileInputRef}
                                ...
                                <div>
                                    ...
                                    {
                                        selectedImage &&
                                        <p onClick={changeImgOption} className='text-[#907974] cursor-pointer'>
                                        Change Image
                                    </p>
                                    }
