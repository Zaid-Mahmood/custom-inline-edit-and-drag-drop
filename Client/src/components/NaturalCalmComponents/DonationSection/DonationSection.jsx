        ...
        <div className="flex items-center">
            <div className="text-center">
                ...
                <button className="mx-auto bg-[#009AFF] px-8 py-4 rounded-md text-white font-medium flex items-center gap-2">
                 <svg className="heartSvg" width="16" height="16" viewBox="0 0 16 16"><path fill="currentColor" d="M8 14.3611C20.957 7.21501 12.8701 -0.965478 8 4.04274C3.12995 -0.965534 -4.957 7.21495 8 14.3611Z"></path></svg> 
                {DonationUtils.btnText} </button>
            </div>
